    ...
    <header className="h-[72px] flex items-center justify-between px-6 lg:px-8 sticky top-0 z-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-100/50 dark:border-slate-800">
      ...
      <div className="flex items-center gap-3 sm:gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="relative p-2 text-text-secondary dark:text-gray-400 hover:text-primary rounded-full hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-gray-200 dark:border-slate-700 text-text-secondary dark:text-gray-300 text-sm font-medium hover:border-primary hover:text-primary transition-colors bg-white dark:bg-slate-800">
